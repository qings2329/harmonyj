...
public class RPC {
    ...
    public Request<?, HmyResponse> getBalanceV2(String oneAddress) {
        return new Request<>(RPCMethod.GetBalanceV2, Arrays.asList(oneAddress), service, HmyResponse.class);
    }
    ...
    public Request<?, HmyResponse> getGasPrice() {
        return new Request<>(RPCMethod.GetGasPrice, Arrays.asList(), service, HmyResponse.class);
    }
